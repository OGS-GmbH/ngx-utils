...
export default defineConfig({
  ...
  description: "This repository provides a lightweight collection of utility functions and helpers for Angular applications. Designed to simplify common tasks such as type checking, formatting, data manipulation, and reactive programming patterns, this library helps improve code readability, reusability, and maintainability across projects.",
  themeConfig: {
    ...
    nav: [
      ...
      { text: packageJson.version, items: [
        { text: "Repository", link: "https://github.com/OGS-GmbH/ngx-utils" },
        { text: "Changelog", link: "https://github.com/OGS-GmbH/ngx-utils/blob/main/CHANGELOG.md" },
      ] }
    ],
    socialLinks: [
